...
import { emphasize, withStyles, useTheme } from '@material-ui/core/styles';
...
class CharacterSelect extends React.Component {
    ...
    handleOnSelect = activeCharacter => {
        this.setState({ value : activeCharacter.value })

        // Set active character in store
        this.props.dispatch({ type : "SET_ACTIVE_CHARACTER", activeCharacter })
        this.props.dispatch(characterAction.getQuotesByCharacter(activeCharacter.value))
    }
    
    handleOnChange = value => {
        this.props.dispatch(characterAction.getCharactersByQuery(value))
    }
            ...
            <div className={classes.root}>
                <div className={classes.select}>
                    <NoSsr>
                        ...
                        placeholder="Start typing your character..."
